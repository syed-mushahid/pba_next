! function(e, t) {
    ...
    var d = function(n) {
        ...
        var e, h, b, o, s, g, p, v, w, u, l, T, C, a, k, m, c, d, y, E = "sizzle" + +new Date,
            x = n.document,
            N = 0,
            r = 0,
            S = ie(),
        ...
        return de.prototype = b.filters = b.pseudos, b.setFilters = new de, g = re.tokenize = function(e, t) {
            ...
            var n, r = [],
                ...
                o = D[e + " "];
            if (!o) {
                for (n = (t = t || g(e)).length; n--;)(o = xe(t[n]))[E] ? r.push(o) : i.push(o);
                (o = D(e, be(i, r))).selector = e
            }
            return o
    ...
    E.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                for (s = J(c), r = 0, i = (o = J(e)).length; r < i; r++) a = o[r], u = s[r], "input" === (l = u.nodeName.toLowerCase()) && V.test(a.type) ? u.checked = a.checked : "input" !== l && "textarea" !== l || (u.defaultValue = a.defaultValue);
            if (t)
                if (n)
...
! function(i, e) {
        ...
        destroy: function() {
            return this.each(function() {
                var e, s = i(this),
                    o = s.data("sfOptions");
                if (!o) return !1;
                e = s.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), f(s, o), c(e), d(s), s.off(".superfish").off(".hoverIntent"), e.children(o.popUpSelector).attr("style", function(e, s) {
        ...
        init: function(n) {
            return this.each(function() {
                ...
                o.$path = (s = o, e.find("li." + s.pathClass).slice(0, s.pathLevels).addClass(s.hoverClass + " " + r).filter(function() {
                    ...
                    }).removeClass(s.pathClass)), e.data("sfOptions", o), f(e, o, !0), c(t, !0), d(e),
                    function(e, s) {
                        var o = "li:has(" + s.popUpSelector + ")";
                        i.fn.hoverIntent && !s.disableHI ? e.hoverIntent(y, w, o) : e.on("mouseenter.superfish", o, y).on("mouseleave.superfish", o, w);
                        var t = "MSPointerDown.superfish";
                        p && (t = "pointerdown.superfish"), h || (t += " touchend.superfish"), l && (t += " mousedown.superfish"), e.on("focusin.superfish", "li", y).on("focusout.superfish", "li", w).on(t, "a", s, g)
    ...
    function g(e) {
        ...
        0 < t.length && t.is(":hidden") && (s.one("click.superfish", !1), "MSPointerDown" === e.type || "pointerdown" === e.type ? s.trigger("focus") : i.proxy(y, s.parent("li"))())
    }
    ...
    l.prototype = {
        ...
        init: function(l) {
            ...
            b.each(m, function(r, t) {
                function i() {
                    var l = p[c]();
                    p[c](l + d), 1 == a && h <= l + d && (l = p[c]()), -1 == a && l + d <= h && (l = p[c]()), p[c]() == l && n && n()
                }
                var n = null,
                    a = 1,
                ...
                t.scroll || (t.scroll = u._getScroll(v["scroll" + r]).addClass("scroll-" + r), v.showArrows && t.scroll.addClass("scroll-element_arrows_visible"), t.mousewheel = function(l) {
                    ...
                    } else a = e.scrollbarOffset + e.scrollbarSize < e.eventOffset ? 1 : e.eventOffset < e.scrollbarOffset ? -1 : 0, "x" === r && v.isRtl && (x.msie || x.msedge) && (a *= -1), d = Math.round(.75 * t.visible) * a, h = e.eventOffset - e.scrollbarOffset - (v.stepScrolling ? 1 == a ? e.scrollbarSize : 0 : Math.round(e.scrollbarSize / 2)), h = p[c]() + h / t.kx;
                    return u.scrollTo = u.scrollTo || {}, u.scrollTo[c] = v.stepScrolling ? p[c]() + d : h, v.stepScrolling && (n = function() {
                        h = p[c](), clearInterval(o), clearTimeout(s), o = s = 0
                    ...
                    return t.scroll.addClass("scroll-draggable"), b(document).on("mousemove" + f, function(l) {
                        ...
                        "x" === r && v.isRtl && (x.msie || x.msedge) && (e *= -1), p[c](o + e)
...
! function(w) {
    ...
    w.prettyPhoto = {
        ...
        function i() {
            w(".pp_loaderIcon").hide(), projectedTop = scroll_pos.scrollTop + (v / 2 - r.containerHeight / 2), projectedTop < 0 && (projectedTop = 0), $ppt.fadeTo(settings.animation_speed, 1), $pp_pic_holder.find(".pp_content").animate({
                height: r.contentHeight,
                width: r.contentWidth
            }, settings.animation_speed), $pp_pic_holder.animate({
                top: projectedTop,
                left: y / 2 - r.containerWidth / 2 < 0 ? 0 : y / 2 - r.containerWidth / 2,
                width: r.containerWidth
            }, settings.animation_speed, function() {
                $pp_pic_holder.find(".pp_hoverContainer,#fullResImage").height(r.height).width(r.width), $pp_pic_holder.find(".pp_fade").fadeIn(settings.animation_speed), isSet && "image" == s(pp_images[set_position]) ? $pp_pic_holder.find(".pp_hoverContainer").show() : $pp_pic_holder.find(".pp_hoverContainer").hide(), settings.allow_expand && (r.resized ? w("a.pp_expand,a.pp_contract").show() : w("a.pp_expand").hide()), !settings.autoplay_slideshow || m || d || w.prettyPhoto.startSlideshow(), settings.changepicturecallback(), d = !0
        ...
        function o(t, e) {
            if (resized = !1, a(t, e), imageWidth = t, imageHeight = e, (y < g || v < _) && doresize && settings.allow_resize && !f) {
                for (resized = !0, fitting = !1; !fitting;) y < g ? (imageWidth = y - 200, imageHeight = e / t * imageWidth) : v < _ ? (imageHeight = v - 200, imageWidth = t / e * imageHeight) : fitting = !0, _ = imageHeight, g = imageWidth;
        ...
        function a(t, e) {
            t = parseFloat(t), e = parseFloat(e), $pp_details = $pp_pic_holder.find(".pp_details"), $pp_details.width(t), detailsHeight = parseFloat($pp_details.css("marginTop")) + parseFloat($pp_details.css("marginBottom")), $pp_details = $pp_details.clone().addClass(settings.theme).width(t).appendTo(w("body")).css({
                ...
                position: "absolute",
                top: -1e4
            }), titleHeight += $pp_title.height(), $pp_title.remove(), h = e + detailsHeight, c = t, _ = h + titleHeight + $pp_pic_holder.find(".pp_top").height() + $pp_pic_holder.find(".pp_bottom").height(), g = t
        }
        ...
        function n() {
            if (doresize && "undefined" != typeof $pp_pic_holder) {
                if (scroll_pos = t(), contentHeight = $pp_pic_holder.height(), contentwidth = $pp_pic_holder.width(), projectedTop = v / 2 + scroll_pos.scrollTop - contentHeight / 2, projectedTop < 0 && (projectedTop = 0), contentHeight > v) return;
                $pp_pic_holder.css({
                    top: projectedTop,
        ...
        function l() {
            ...
            }), settings.allow_expand && w("a.pp_expand").bind("click", function() {
                return doresize = w(this).hasClass("pp_expand") ? (w(this).removeClass("pp_expand").addClass("pp_contract"), !1) : (w(this).removeClass("pp_contract").addClass("pp_expand"), !0), p(function() {
                    w.prettyPhoto.open()
                }), !1
        ...
        var r, d, h, c, _, g, m, u = this,
            f = !1,
            v = w(window).height(),
            y = w(window).width();
        return doresize = !0, scroll_pos = t(), w(window).unbind("resize.prettyphoto").bind("resize.prettyphoto", function() {
            ...
            return settings = e, "pp_default" == settings.theme && (settings.horizontal_padding = 16), theRel = w(this).attr(settings.hook), galleryRegExp = /\[(?:.*)\]/, isSet = !!galleryRegExp.exec(theRel), pp_images = isSet ? jQuery.map(u, function(t) {
                return -1 != w(t).attr(settings.hook).indexOf(theRel) ? w(t).attr("href") : void 0
            }) : w.makeArray(w(this).attr("href")), pp_titles = isSet ? jQuery.map(u, function(t) {
                return -1 != w(t).attr(settings.hook).indexOf(theRel) ? w(t).find("img").attr("alt") ? w(t).find("img").attr("alt") : "" : void 0
            }) : w.makeArray(w(this).find("img").attr("alt")), pp_descriptions = isSet ? jQuery.map(u, function(t) {
                return -1 != w(t).attr(settings.hook).indexOf(theRel) ? w(t).attr("title") ? w(t).attr("title") : "" : void 0
            }) : w.makeArray(w(this).attr("title")), pp_images.length > settings.overlay_gallery_max && (settings.overlay_gallery = !1), set_position = jQuery.inArray(w(this).attr("href"), pp_images), rel_index = isSet ? set_position : w("a[" + settings.hook + "^='" + theRel + "']").index(w(this)), l(), settings.allow_resize && w(window).bind("scroll.prettyphoto", function() {
                n()
            ...
            return "undefined" == typeof settings && (settings = e, pp_images = w.makeArray(t), pp_titles = w.makeArray(arguments[1] ? arguments[1] : ""), pp_descriptions = w.makeArray(arguments[2] ? arguments[2] : ""), isSet = 1 < pp_images.length, set_position = arguments[3] ? arguments[3] : 0, l(t.target)), settings.hideflash && w("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css("visibility", "hidden"), 1 < w(pp_images).size() ? w(".pp_nav").show() : w(".pp_nav").hide(), w(".pp_loaderIcon").show(), !settings.deeplinking || "undefined" != typeof theRel && (location.hash = theRel + "/" + rel_index + "/"), settings.social_tools && (facebook_like_link = settings.social_tools.replace("{location_href}", encodeURIComponent(location.href)), $pp_pic_holder.find(".pp_social").html(facebook_like_link)), $ppt.is(":hidden") && $ppt.css("opacity", 0).show(), $pp_overlay.show().fadeTo(settings.animation_speed, settings.opacity), $pp_pic_holder.find(".currentTextHolder").text(set_position + 1 + settings.counter_separator_label + w(pp_images).size()), void 0 !== pp_descriptions[set_position] && "" != pp_descriptions[set_position] ? $pp_pic_holder.find(".pp_description").show().html(unescape(pp_descriptions[set_position])) : $pp_pic_holder.find(".pp_description").hide(), movie_width = parseFloat(k("width", pp_images[set_position])) ? k("width", pp_images[set_position]) : settings.default_width.toString(), movie_height = parseFloat(k("height", pp_images[set_position])) ? k("height", pp_images[set_position]) : settings.default_height.toString(), f = !1, -1 != movie_height.indexOf("%") && (movie_height = parseFloat(w(window).height() * parseFloat(movie_height) / 100 - 150), f = !0), -1 != movie_width.indexOf("%") && (movie_width = parseFloat(w(window).width() * parseFloat(movie_width) / 100 - 150), f = !0), $pp_pic_holder.fadeIn(function() {
                switch ($ppt.html(settings.show_title && "" != pp_titles[set_position] && void 0 !== pp_titles[set_position] ? unescape(pp_titles[set_position]) : "&nbsp;"), imgPreloader = "", skipInjection = !1, s(pp_images[set_position])) {
                    case "image":
                        ...
                        break;
                    case "youtube":
                        r = o(movie_width, movie_height), movie_id = k("v", pp_images[set_position]), "" == movie_id && (movie_id = pp_images[set_position].split("youtu.be/"), movie_id = movie_id[1], 0 < movie_id.indexOf("?") && (movie_id = movie_id.substr(0, movie_id.indexOf("?"))), 0 < movie_id.indexOf("&") && (movie_id = movie_id.substr(0, movie_id.indexOf("&")))), movie = "http://www.youtube.com/embed/" + movie_id, movie += k("rel", pp_images[set_position]) ? "?rel=" + k("rel", pp_images[set_position]) : "?rel=1", settings.autoplay && (movie += "&autoplay=1"), toInject = settings.iframe_markup.replace(/{width}/g, r.width).replace(/{height}/g, r.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, movie);
                        break;
                    case "vimeo":
                        r = o(movie_width, movie_height), movie_id = pp_images[set_position];
                        var t = movie_id.match(/http(s?):\/\/(www\.)?vimeo.com\/(\d+)/);
                        movie = "http://player.vimeo.com/video/" + t[3] + "?title=0&byline=0&portrait=0", settings.autoplay && (movie += "&autoplay=1;"), vimeo_width = r.width + "/embed/?moog_width=" + r.width, toInject = settings.iframe_markup.replace(/{width}/g, vimeo_width).replace(/{height}/g, r.height).replace(/{path}/g, movie);
                        break;
                    case "quicktime":
                        (r = o(movie_width, movie_height)).height += 15, r.contentHeight += 15, r.containerHeight += 15, toInject = settings.quicktime_markup.replace(/{width}/g, r.width).replace(/{height}/g, r.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, pp_images[set_position]).replace(/{autoplay}/g, settings.autoplay);
                        break;
                    case "flash":
                        r = o(movie_width, movie_height), flash_vars = pp_images[set_position], flash_vars = flash_vars.substring(pp_images[set_position].indexOf("flashvars") + 10, pp_images[set_position].length), filename = pp_images[set_position], filename = filename.substring(0, filename.indexOf("?")), toInject = settings.flash_markup.replace(/{width}/g, r.width).replace(/{height}/g, r.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, filename + "?" + flash_vars);
                        break;
                    case "iframe":
                        r = o(movie_width, movie_height), frame_url = pp_images[set_position], frame_url = frame_url.substr(0, frame_url.indexOf("iframe") - 1), toInject = settings.iframe_markup.replace(/{width}/g, r.width).replace(/{height}/g, r.height).replace(/{path}/g, frame_url);
                        break;
                    case "ajax":
                        doresize = !1, r = o(movie_width, movie_height), doresize = !0, skipInjection = !0, w.get(pp_images[set_position], function(t) {
                    ...
                    case "inline":
                        ...
                        }).wrapInner('<div id="pp_full_res"><div class="pp_inline"></div></div>').appendTo(w("body")).show(), doresize = !1, r = o(w(myClone).width(), w(myClone).height()), doresize = !0, w(myClone).remove(), toInject = settings.inline_markup.replace(/{content}/g, w(pp_images[set_position]).html())
                }
                imgPreloader || skipInjection || ($pp_pic_holder.find("#pp_full_res")[0].innerHTML = toInject, i())
            }), !1
        }, w.prettyPhoto.changePage = function(t) {
            currentGalleryPage = 0, "previous" == t ? (set_position--, set_position < 0 && (set_position = w(pp_images).size() - 1)) : "next" == t ? (set_position++, set_position > w(pp_images).size() - 1 && (set_position = 0)) : set_position = t, rel_index = set_position, doresize = doresize || !0, settings.allow_expand && w(".pp_contract").removeClass("pp_contract").addClass("pp_expand"), p(function() {
                w.prettyPhoto.open()
            })
            ...
            void 0 === m ? ($pp_pic_holder.find(".pp_play").unbind("click").removeClass("pp_play").addClass("pp_pause").click(function() {
                return w.prettyPhoto.stopSlideshow(), !1
            }), m = setInterval(w.prettyPhoto.startSlideshow, settings.slideshow)) : w.prettyPhoto.changePage("next")
            ...
            $pp_overlay.is(":animated") || (w.prettyPhoto.stopSlideshow(), $pp_pic_holder.stop().find("object,embed").css("visibility", "hidden"), w("div.pp_pic_holder,div.ppt,.pp_fade").fadeOut(settings.animation_speed, function() {
                ...
                settings.hideflash && w("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css("visibility", "visible"), w(this).remove(), w(window).unbind("scroll.prettyphoto"), -1 !== location.href.indexOf("#prettyPhoto") && (location.hash = "prettyPhoto"), settings.callback(), doresize = !0, d = !1, delete settings
            }))
    ...
    m.JQPlugin.createPlugin({
        ...
        _generateHTML: function(i) {
            ...
            function l(t) {
                ...
                return o[t] ? s._translateDigits(i, i._periods[t]) + (e ? e[t] : _[t]) + " " : ""
            }

            function p(t) {
                var e = i.options["labels" + c(i._periods[t])];
                return !i.options.significant && o[t] || i.options.significant && r[t] ? '<span class="' + s._sectionClass + '"><span class="' + s._amountClass + '">' + s._minDigits(i, i._periods[t], u) + '</span><span class="' + s._periodClass + '">' + (e ? e[t] : _[t]) + "</span></span>" : ""
            }
            var _ = i.options.compact ? i.options.compactLabels : i.options.labels,
                c = i.options.whichLabels || this._normalLabels,
                u = i.options.padZeroes ? 2 : 1;
            return i.options.layout ? this._buildLayout(i, o, i.options.layout, i.options.compact, i.options.significant, r) : (i.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (i._hold ? " " + this._holdingClass : "") + '">' + l(0) + l(1) + l(2) + l(3) + (o[4] ? this._minDigits(i, i._periods[4], 2) : "") + (o[5] ? (o[4] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[5], 2) : "") + (o[6] ? (o[4] || o[5] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (i.options.significant || e) + (i._hold ? " " + this._holdingClass : "") + '">' + p(0) + p(1) + p(2) + p(3) + p(4) + p(5) + p(6)) + "</span>" + (i.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + i.options.description + "</span>" : "")
        },
        _buildLayout: function(i, t, e, s, n, o) {
            function a(t) {
                return (i.options[(s ? "compactLabels" : "labels") + p(i._periods[t])] || l)[t]
            }

            function r(t, e) {
                return i.options.digits[Math.floor(t / e) % 10]
            }
            for (var l = i.options[s ? "compactLabels" : "labels"], p = i.options.whichLabels || this._normalLabels, _ = {
        ...
        _calculatePeriods: function(t, i, e, s) {
            ...
            if (i[0] || i[1]) {
                ...
                var r = this._getDaysInMonth(s.getFullYear(), s.getMonth()),
                    l = this._getDaysInMonth(n.getFullYear(), n.getMonth()),
                    p = n.getDate() == s.getDate() || n.getDate() >= Math.min(r, l) && s.getDate() >= Math.min(r, l),
                    _ = Math.max(0, 12 * (n.getFullYear() - s.getFullYear()) + n.getMonth() - s.getMonth() + (n.getDate() < s.getDate() && !p || p && a(n) < a(s) ? -1 : 0));
            ...
            function h(t, e) {
                o[t] = i[t] ? Math.floor(d / e) : 0, d -= o[t] * e
            }
            var d = Math.floor((n.getTime() - s.getTime()) / 1e3);
            if (h(2, 604800), h(3, 86400), h(4, 3600), h(5, 60), h(6, 1), 0 < d && !t._since)
                for (var m = [1, 12, 4.3482, 7, 24, 60, 60], g = 6, f = 1, w = 6; 0 <= w; w--) i[w] && (o[g] >= f && (o[g] = 0, d = 1), 0 < d && (o[w]++, d = 0, g = w, f = 1)), f *= m[w];
            if (e)
...
function() {
    ...
    function(a) {
        ...
        var u = "undefined" == typeof console ? function() {} : function(t) {
                console.error(t)
            },
    ...
    function(r, s) {
        ...
        return r.namespace = "outlayer", r.Item = o, r.defaults = {
            ...
            }).prototype = new o, s.htmlInit(i, t), p && p.bridget && p.bridget(t, i), i
        }, r.Item = o, r
    }),
    function(t, e) {
...
function(c, e) {
    ...
    i.Defaults = {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + o + "></div>"), this._core.settings.lazyLoad && (a = "data-src", h = "owl-lazy"), r.length ? (i(r.attr(a)), r.remove(), !1) : void("youtube" === t.type ? (n = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", i(n)) : "vimeo" === t.type ? c.ajax({
            type: "GET",
    ...
    b.flexslider = function(p, e) {
        ...
        b.data(p, "flexslider", m), y = {
            init: function() {
                ...
                }), m.container.empty().append(m.slides)), m.doMath(), m.setup("init"), m.vars.controlNav && y.controlNav.setup(), m.vars.directionNav && y.directionNav.setup(), m.vars.keyboard && (1 === b(m.containerSelector).length || m.vars.multipleKeyboard) && b(document).bind("keyup", function(e) {
                    var t = e.keyCode;
                ...
                }), m.vars.pausePlay && y.pausePlay.setup(), m.vars.slideshow && m.vars.pauseInvisible && y.pauseInvisible.init(), m.vars.slideshow && (m.vars.pauseOnHover && m.hover(function() {
                    m.manualPlay || m.manualPause || m.pause()
                }, function() {
                    m.manualPause || m.manualPlay || m.stopped || m.play()
                }), m.vars.pauseInvisible && y.pauseInvisible.isHidden() || (0 < m.vars.initDelay ? m.startTimeout = setTimeout(m.play, m.vars.initDelay) : m.play())), v && y.asNav.setup(), u && m.vars.touch && y.touch(), (!x || x && m.vars.smoothHeight) && b(window).bind("resize orientationchange focus", y.resize), m.find("img").attr("draggable", "false"), setTimeout(function() {
                    m.vars.start(m)
                }, 200)
            },
            asNav: {
            ...
            controlNav: {
                setup: function() {
                    m.manualControls ? y.controlNav.setupManual() : y.controlNav.setupPaging()
                },
                setupPaging: function() {
                    ...
                    m.controlsContainer ? b(m.controlsContainer).append(m.controlNavScaffold) : m.append(m.controlNavScaffold), y.controlNav.set(), y.controlNav.active(), m.controlNavScaffold.delegate("a, img", o, function(e) {
                ...
                setupManual: function() {
                    m.controlNav = m.manualControls, y.controlNav.active(), m.controlNav.bind(o, function(e) {
                        if (e.preventDefault(), "" === l || l === e.type) {
                            var t = b(this),
                                a = m.controlNav.index(t);
                ...
                update: function(e, t) {
                    1 < m.pagingCount && "add" === e ? m.controlNavScaffold.append(b('<li><a href="#">' + m.count + "</a></li>")) : 1 === m.pagingCount ? m.controlNavScaffold.find("li").remove() : m.controlNav.eq(t).closest("li").remove(), y.controlNav.set(), 1 < m.pagingCount && m.pagingCount !== m.controlNav.length ? m.update(t, e) : y.controlNav.active()
                }
            },
            directionNav: {
                setup: function() {
                    ...
                    m.customDirectionNav ? m.directionNav = m.customDirectionNav : m.controlsContainer ? (b(m.controlsContainer).append(e), m.directionNav = b("." + d + "direction-nav li a", m.controlsContainer)) : (m.append(e), m.directionNav = b("." + d + "direction-nav li a", m)), y.directionNav.update(), m.directionNav.bind(o, function(e) {
                        var t;
                        e.preventDefault(), "" !== l && l !== e.type || (t = b(this).hasClass(d + "next") ? m.getTarget("next") : m.getTarget("prev"), m.flexAnimate(t, m.vars.pauseOnAction)), "" === l && (l = e.type), y.setToClearWatchedEvent()
                    })
                },
                update: function() {
                    var e = d + "disabled";
            ...
            pausePlay: {
                setup: function() {
                    ...
                    m.controlsContainer ? (m.controlsContainer.append(e), m.pausePlay = b("." + d + "pauseplay a", m.controlsContainer)) : (m.append(e), m.pausePlay = b("." + d + "pauseplay a", m)), y.pausePlay.update(m.vars.slideshow ? d + "pause" : d + "play"), m.pausePlay.bind(o, function(e) {
                        e.preventDefault(), "" !== l && l !== e.type || (b(this).hasClass(d + "pause") ? (m.manualPause = !0, m.manualPlay = !1, m.pause()) : (m.manualPause = !1, m.manualPlay = !0, m.play())), "" === l && (l = e.type), y.setToClearWatchedEvent()
                    })
                },
                update: function(e) {
                ...
                f ? (p.style.msTouchAction = "none", p._gesture = new MSGesture, (p._gesture.target = p).addEventListener("MSPointerDown", function(e) {
                    ...
                    if (t) {
                        ...
                        return l = v += g ? n : a, u = g ? Math.abs(v) < Math.abs(-a) : Math.abs(v) < Math.abs(-n), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            p._gesture.stop()
                        }) : void((!u || 500 < Number(new Date) - c) && (e.preventDefault(), !x && t.transitions && (t.vars.animationLoop || (l = v / (0 === t.currentSlide && v < 0 || t.currentSlide === t.last && 0 < v ? Math.abs(v) / o + 2 : 1)), t.setProps(r + l, "setTouch"))))
                    }
                    ...
                    if (t) {
                        if (t.animatingTo === t.currentSlide && !u && null !== l) {
                            ...
                            t.canAdvance(n) && (Number(new Date) - c < 550 && 50 < Math.abs(a) || Math.abs(a) > o / 2) ? t.flexAnimate(n, t.vars.pauseOnAction) : x || t.flexAnimate(t.currentSlide, t.vars.pauseOnAction, !0)
                        }
                        r = l = s = i = null, v = 0
                    }
                }, !1)) : (e = function(e) {
                    ...
                    (!(u = g ? Math.abs(l) < Math.abs(t - s) : Math.abs(l) < Math.abs(a - s)) || 500 < Number(new Date) - c) && (e.preventDefault(), !x && m.transitions && (m.vars.animationLoop || (l /= 0 === m.currentSlide && l < 0 || m.currentSlide === m.last && 0 < l ? Math.abs(l) / o + 2 : 1), m.setProps(r + l, "setTouch")))
                }, d = function(e) {
                    if (p.removeEventListener("touchmove", n, !1), m.animatingTo === m.currentSlide && !u && null !== l) {
                        var t = h ? -l : l,
                            a = 0 < t ? m.getTarget("next") : m.getTarget("prev");
                        m.canAdvance(a) && (Number(new Date) - c < 550 && 50 < Math.abs(t) || Math.abs(t) > o / 2) ? m.flexAnimate(a, m.vars.pauseOnAction) : x || m.flexAnimate(m.currentSlide, m.vars.pauseOnAction, !0)
                    }
                    p.removeEventListener("touchend", d, !1), r = l = s = i = null
                }, p.addEventListener("touchstart", e, !1))
            },
            resize: function() {
                !m.animating && m.is(":visible") && (S || m.doMath(), x ? y.smoothHeight() : S ? (m.slides.width(m.computedW), m.update(m.pagingCount), m.setProps()) : g ? (m.viewport.height(m.h), m.setProps(m.h, "setTotal")) : (m.vars.smoothHeight && y.smoothHeight(), m.newSlides.width(m.computedW), m.setProps(m.computedW, "setTotal")))
            },
                ...
                init: function() {
                    ...
                    if (e) {
                        ...
                        document.addEventListener(t, function() {
                            y.pauseInvisible.isHidden() ? m.startTimeout ? clearTimeout(m.startTimeout) : m.pause() : !m.started && 0 < m.vars.initDelay ? setTimeout(m.play, m.vars.initDelay) : m.play()
                        })
                    }
                },
                isHidden: function() {
            ...
            if (m.vars.animationLoop || e === m.currentSlide || (m.direction = e > m.currentSlide ? "next" : "prev"), v && 1 === m.pagingCount && (m.direction = m.currentItem < e ? "next" : "prev"), !m.animating && (m.canAdvance(e, i) || a) && m.is(":visible")) {
                ...
                if (m.animating = !0, m.animatingTo = e, t && m.pause(), m.vars.before(m), m.syncExists && !i && y.sync("animate"), m.vars.controlNav && y.controlNav.active(), S || m.slides.removeClass(d + "active-slide").eq(e).addClass(d + "active-slide"), m.atEnd = 0 === e || e === m.last, m.vars.directionNav && y.directionNav.update(), e === m.last && (m.vars.end(m), m.vars.animationLoop || m.pause()), x) u ? (m.slides.eq(m.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), m.slides.eq(e).css({
                    opacity: 1,
            ...
            clearInterval(m.animatedSlides), m.animatedSlides = null, m.playing = !1, m.vars.pausePlay && y.pausePlay.update("play"), m.syncExists && y.sync("pause")
        }, m.play = function() {
            m.playing && clearInterval(m.animatedSlides), m.animatedSlides = m.animatedSlides || setInterval(m.animateSlides, m.vars.slideshowSpeed), m.started = m.playing = !0, m.vars.pausePlay && y.pausePlay.update("pause"), m.syncExists && y.sync("play")
        }, m.stop = function() {
            m.pause(), m.stopped = !0
            ...
            x ? (m.slides.css({
                ...
                opacity: 1
            }, m.vars.animationSpeed, m.vars.easing)), m.vars.smoothHeight && y.smoothHeight()) : ("init" === e && (m.viewport = b('<div class="' + d + 'viewport"></div>').css({
                overflow: "hidden",
                position: "relative"
            ...
            m.doMath(), S || (e < m.currentSlide ? m.currentSlide += 1 : e <= m.currentSlide && 0 !== e && --m.currentSlide, m.animatingTo = m.currentSlide), m.vars.controlNav && !m.manualControls && ("add" === t && !S || m.pagingCount > m.controlNav.length ? y.controlNav.update("add") : ("remove" === t && !S || m.pagingCount < m.controlNav.length) && (S && m.currentSlide > m.last && (--m.currentSlide, --m.animatingTo), y.controlNav.update("remove", m.last))), m.vars.directionNav && y.directionNav.update()
            ...
            --m.count, m.last = m.count - 1, isNaN(e) ? b(e, m.slides).remove() : g && h ? m.slides.eq(m.last).remove() : m.slides.eq(e).remove(), m.doMath(), m.update(t, "remove"), m.slides = b(m.vars.selector + ":not(.clone)", m), m.setup(), m.vars.removed(m)
        }, y.init()
    ...
    function(l) {
        var s = {
            ...
            initialize: function(t, e) {
                this.elem = e, this.$elem = l(e), this.accessData = l.fn.spectragram.accessData, this.accessToken = this.accessData.accessToken, this.clientID = this.accessData.clientID, this.userCredentials = this.clientID + "&access_token=" + this.accessToken, this.options = l.extend({}, l.fn.spectragram.options, t), this.messages = {
            ...
            getUserFeed: function() {
                var s = this,
                    t = "/users/search?q=" + s.options.query + "&count=" + s.options.max + "&access_token=" + s.accessToken,
                    i = !1;
                s.fetch(t).done(function(t) {
                    if (t.data.length)
                        for (var e = t.data.length, a = 0; a < e; a++) t.data[a].username === s.options.query && (s.getRecentMedia(t.data[a].id), i = !0);
                    !1 === i && l.error("Spectragram.js - Error: the username " + s.options.query + " does not exist.")
                })
            },
            getPopular: function() {
                var e = this,
                    t = "/media/popular?client_id=" + e.userCredentials;
            ...
            getRecentTagged: function() {
                var e = this,
                    t = "/tags/" + e.options.query + "/media/recent?client_id=" + e.userCredentials;
                e.fetch(t).done(function(t) {
                    t.data.length ? e.display(t) : l.error("Spectragram.js - Error: the tag " + e.options.query + " does not have results.")
                })
            },
            fetch: function(t) {
            ...
            display: function(t) {
                ...
                if (s = 0 === l(this.options.wrapEachWith).length, void 0 === t.data || 200 !== t.meta.code || 0 === t.data.length) s ? this.$elem.append(this.messages.notFound) : this.$elem.append(l(this.options.wrapEachWith).append(this.messages.notFound));
                    ...
                    for (var u = 0; u < r; u++) o = "small" === c ? (h = t.data[u].images.thumbnail.url, n = t.data[u].images.thumbnail.height, t.data[u].images.thumbnail.width) : "medium" === c ? (h = t.data[u].images.low_resolution.url, n = t.data[u].images.low_resolution.height, t.data[u].images.low_resolution.width) : (h = t.data[u].images.standard_resolution.url, n = t.data[u].images.standard_resolution.height, t.data[u].images.standard_resolution.width), i = null !== t.data[u].caption ? l("<span>").text(t.data[u].caption.text).html() : this.messages.defaultImageAltText, a = l("<img>", {
                        ...
                        target: "_blank",
                        title: i
                    }).append(a), s ? d.push(e) : d.push(l(this.options.wrapEachWith).append(e));
                    this.$elem.append(d)
                }
        ...
        jQuery.fn.spectragram = function(e, a) {
            jQuery.fn.spectragram.accessData.clientID ? this.each(function() {
                ...
                if (t.initialize(a, this), t[e]) return t[e](this);
                l.error("Method " + e + " does not exist on jQuery.spectragram")
            }) : l.error("You must define an accessToken and a clientID on jQuery.spectragram")
...
! function(e) {
    ...
    l.cleanData = (a = l.cleanData, function(e) {
        ...
        l.Widget.prototype["_" + a] = function(t, e, i) {
            ...
            var s, n = e ? !0 !== e && "number" != typeof e && e.effect || o : a;
            "number" == typeof(e = e || {}) && (e = {
                duration: e
    ...
    l(document).mouseup(function() {
        ...
        _mouseMove: function(e) {
            return (!l.ui.ie || document.documentMode && !(document.documentMode < 9) || e.button) && e.which ? this._mouseStarted ? (this._mouseDrag(e), e.preventDefault()) : (this._mouseDistanceMet(e) && this._mouseDelayMet(e) && (this._mouseStarted = !1 !== this._mouseStart(this._mouseDownEvent, e), this._mouseStarted ? this._mouseDrag(e) : this._mouseUp(e)), !this._mouseStarted) : this._mouseUp(e)
        },
        _mouseUp: function(e) {
            ...
            o.username && "string" == typeof o.username && (o.username = [o.username]), c(n).unbind("tweet:load").bind("tweet:load", function() {
                o.loading_text && c(n).empty().append(t), c.ajax({
                    ...
                    success: function(e, t) {
                        ...
                        var r = e.response;
                        c(n).empty().append(i), o.intro_text && i.before(s), i.empty(), resp = void 0 !== r.statuses ? r.statuses : void 0 !== r.results ? r.results : r;
                        var a = c.map(resp, l);
